...
class MultiProductBuilder:
    ...
    def fit(self, train_df: pd.DataFrame, n: int | None = None, upcs: list | None = None, stores: list | None = None) -> "MultiProductBuilder":
        ...
        train_filtered = self.filter.run(train_df, self.selector.selected_upcs, self.store_selector.selected_stores)
